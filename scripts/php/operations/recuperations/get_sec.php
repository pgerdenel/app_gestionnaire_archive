<?php
/**
 * Renvoie la liste des types secondaires enregistrés dans la BDD
 * Données renvoyées: objet json{"result":"ok", "list":["", "", ""]}
 * {"result":true,"list":["civiles","religieuses"]}
 * Paramètres obligatoires : aucun
 * URL: http://localhost/arch/scripts/php/get_sec.php
 **/
...
try
{
    ...
    $connexion = $connexion->prepare("SELECT nom_type_secondaire_archive FROM type_secondaire_archive");
