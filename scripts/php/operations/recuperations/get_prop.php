<?php
/**
 * Renvoie la liste des proprio enregistrés dans la BDD
 * Données renvoyées: objet json{"result":"ok", "list":["", "", ""]}
 * {"result":true,"list":["thl","..."]}
 * Paramètres obligatoires : aucun
 * URL: http://localhost/arch/scripts/php/get_prop.php
 **/
...
try
{
    ...
    $connexion = $connexion->prepare("SELECT nom_proprietaire FROM proprietaire");
