<?php
/**
 * Renvoie la liste des ID et noms de type tertiaires enregistrés dans la BDD
 * Données renvoyées: objet json{"result":"ok", "list":{"1":"conference", "2", "restauration"}}
 * Paramètres obligatoires : aucun
 * URL: http://localhost/arch/scripts/php/get_type_ter_form.php
 **/
...
try
{
    ...
    $db = $db->prepare("SELECT ID_TYPE_TERTIAIRE_ARCHIVE, NOM_TYPE_TERTIAIRE_ARCHIVE FROM type_tertiaire_archive");
