<?php
/**
 * Renvoie la liste des types d'édifices enregistrés dans la BDD
 * Données renvoyées: objet json{"result":"ok", "list":["", "", ""]}
 * {"result":true,"list":["eglise","chateau", "maison"]}
 * Paramètres obligatoires : aucun
 * URL: http://localhost/arch/scripts/php/get_type_edi.php
 **/
...
try
{
    ...
    $connexion = $connexion->prepare("SELECT NOM_TYPE_EDIFICE FROM type_edifice");
