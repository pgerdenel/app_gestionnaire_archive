<?php
/**
 * Renvoie la liste des ID et noms de proprio enregistrés dans la BDD
 * Données renvoyées: objet json{"result":"ok", "list":{"1":"michel", "2", "thibault"}}
 * Paramètres obligatoires : aucun
 * URL: http://localhost/arch/scripts/php/get_prop_form.php
 **/
...
try
{
    ...
    $db = $db->prepare("SELECT ID_PROPRIETAIRE, NOM_PROPRIETAIRE FROM proprietaire");
