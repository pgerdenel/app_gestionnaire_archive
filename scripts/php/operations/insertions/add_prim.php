<?php
/**
 * Ajoute un type primaire dans la base de donne
 * Données renvoyées: true or false
 * Paramètres obligatoires : type_primaire = $çPOST['prim']
 * URL: http://localhost/arch/scripts/php/add_prim.php?prim=familiale
 **/
...
// if(isset($_GET['prim']) && !empty($_GET['prim'])) {
    ...
    try
    {
        ...
        $connexion = $connexion->prepare("INSERT INTO type_primaire_archive(`NOM_TYPE_PRIMAIRE_ARCHIVE`) VALUES (:value)");
