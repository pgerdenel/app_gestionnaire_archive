 ...
 * URL: http://localhost/arch/scripts/php/add_sec.php?sec=test
 **/
...
// if(isset($_GET['prim']) && !empty($_GET['prim'])) {
    ...
    try
    {
        ...
        $connexion = $connexion->prepare("INSERT INTO type_secondaire_archive(`NOM_TYPE_SECONDAIRE_ARCHIVE`) VALUES (:value)");
    ...
    echo '<p style="color:red">Erreur de paramètre, la donnée type secondaire n\'est pas correcte</p>';
}