<?php
/**
 * Ajoute un type d'édifice dans la base de donne
 * Données renvoyées: true or false
 * Paramètres obligatoires : type_édifice = $POST['edi']
 * URL: http://localhost/arch/scripts/php/add_edi.php?edi=test
 **/
...
// if(isset($_GET['prim']) && !empty($_GET['prim'])) {
    ...
    try
    {
        ...
        $connexion = $connexion->prepare("INSERT INTO type_edifice(`NOM_TYPE_EDIFICE`) VALUES (:value)");
